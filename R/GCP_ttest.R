...
#' @param raw_or_LFQ one of the following: "raw", "LFQ". The t-test will be performed only in the specified data intensities.
...
#'
#' @export
GCP_ttest <- function(GCPlist, raw_or_LFQ = c("raw", "LFQ"), name_column_groups,
